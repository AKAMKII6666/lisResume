      ...
      scrolling() {
        ...
        if (this.vRelScroHeight >= 420) {
          ...
          $(this.$refs.mainContainer).css(
            'transform',
            'scale(' +
              this._mainController.nc(this.vRelScroHeight, 420, 520, 0.15, 1) +
              ')'
          )
        } else {
          this.next('hide')
          ...
          $(this.$refs.mainContainer).css(
            'transform',
            'scale(' +
              this._mainController.nc(this.vRelScroHeight, 5, 55, 1, 1.5) +
              ')'
          )
        }
...
<style lang="stylus" >
  ...
  .mainContainer.sks
    ...
    .scWindow
      ...
      .skillsContainer
        overflow: hidden
        width: 3.835rem /* 767px -> 3.835rem */
        margin: auto
        margin-top: 3.415rem /* 683px -> 3.415rem */
        display: none
