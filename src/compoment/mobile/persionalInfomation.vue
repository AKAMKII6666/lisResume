<template>
  ...
  >
    ...
    <div class="cont" ref="ageLabel">今年32岁</div>
    ...
    <div class="cont" ref="placeLabel">目前在深圳龙华</div>
    ...
    methods: {
      ...
      scrolling() {
        ...
        if (this.vRelScroHeight >= 105) {
          ...
          var r = this._mainController
            .nc(this.vRelScroHeight, 110, 160, 82, 67)
            .toFixed(0)
          var g = this._mainController
            .nc(this.vRelScroHeight, 110, 160, 179, 67)
            .toFixed(0)
          var b = this._mainController
            .nc(this.vRelScroHeight, 110, 160, 43, 67)
            .toFixed(0)
          //介绍文本的颜色进行字体样式过度
          for (var i = 0; i < arr.length; i++) {
          ...
          r = this._mainController
            .nc(this.vRelScroHeight, 110, 160, 82, 27)
            .toFixed(0)
          g = this._mainController
            .nc(this.vRelScroHeight, 110, 160, 179, 27)
            .toFixed(0)
          b = this._mainController
            .nc(this.vRelScroHeight, 110, 160, 43, 27)
            .toFixed(0)
          $(this.$refs.helloLabel).css(
            'color',
            'rgb(' + r + ',' + g + ',' + b + ')'
          ...
          //背景的透明度从1变成0
          var opacity = this._mainController.nc(
            this.vRelScroHeight,
            110,
            115,
            0,
          ...
          $(this.$refs.mainContainer).css(
            'transform',
            'scale(' +
              this._mainController.nc(this.vRelScroHeight, 110, 160, 0.5, 1) +
              ')'
          )
          ...
          var opacity2 = this._mainController.nc(
            this.vRelScroHeight,
            110,
            115,
            1,
