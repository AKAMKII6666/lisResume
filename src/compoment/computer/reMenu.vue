<template>
  <table
    ...
    :style="{ marginTop: moveDetal.y + 'px', marginLeft: moveDetal.x + 'px' }"
    @click="hideContent()"
  >
    <tr>
      <td valign="middle">
        ...
        <div class="menus">
          <div
            ...
            :style="{
              textShadow:
                moveShadow.x + 'px ' + moveShadow.y + 'px 10px rgba(0,0,0,0.8)',
            }"
  ...
  export default {
    ...
    methods: {
      ...
      switchContent(_e, _item) {
        ...
        if (
          typeof _e.preventDefault !== 'undefined' ||
          typeof _e.stopPropagation !== 'undefined'
        ) {
          _e.stopPropagation()
          _e.preventDefault()
