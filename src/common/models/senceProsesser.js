...
//场景处理器
export default {
	senceProsesser: function (_selfApp) {
		...
		for (var i = 0; i < elems.length; i++) {
			...
			window.sences[item.attr("data-s")] = {
				...
				model: modelsMap[item.attr("data-m")],
				player: null,
				loadFunc: function () {},
				show: function () {
		...
		//老浏览器就不要搞这些了
		if (!window.isOldBrowser) {
			require(["three", "models/publish/js/app.js", "models/publish/js/VRButton.js"], function (
				_three,
				_APP,
				_VRButton
			) {
